...
public $day_closed					= array("Friday"); 	// If you don't want any 'closed' days, remove the day so it becomes: = array();
public $day_closed_text				= "CLOSED"; 		// If you don't want any any 'closed' remove the text so it becomes: = "";

// Cost Related Variables
public $cost_per_slot				= 50;			// The cost per slot
public $cost_currency_tag			= "LE ";		// The currency tag in HTML such as &euro; &pound; &yen;


//  DO NOT EDIT BELOW THIS LINE

public $day_order	 				= array( "Friday", "Saturday", "Sunday","Monday", "Tuesday", "Wednesday", "Thursday");
...
function make_booking_array($year, $month, $j = 0) { 
	$query = "SELECT * FROM reservation WHERE date LIKE '$year-$month%'"; 
...
function basket($selected_day = '') {
	...
	include 'includes/reser_menu.php';
	echo"
					...
					<input type='radio' name='pay' value='cheque'>cheque</br>
					<input type='radio' name='pay' value='visa'>visa</br>
